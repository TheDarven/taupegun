...
public class PlayerDto {
	...
	public PlayerDto(UUID uuid, String pseudo, boolean victory, int mole, int supermole, String teamName, boolean is_spectator, boolean is_alive, long last_connection, int time_played) {
		this.uuid = uuid;
		this.pseudo = pseudo;
