...
public class NumericParams {
     ...
     * @param showDisabled Afficher "désactiver" si la valeur est à true
     * @param getterFactor Multiplicateur qui multiplie la valeur dans les getters de comparaison
     */
    public NumericParams(int min, int max, int value, int pas, int morePas, String afterName, int divider, boolean showDisabled, double getterFactor) {
        this.min = min;
        this.max = max;
        this.value = value;
        this.pas = pas;
