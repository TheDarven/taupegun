...
public abstract class InventoryBuilder implements Listener {
	...
	public InventoryBuilder(TaupeGun main, String pName, String pDescription, String pTranslationName, int pLines, Material pMaterial, CustomInventory pParent, int pPosition, byte pData) {
		this.main = main;
		this.name = pName;
	...
	public InventoryBuilder(TaupeGun main, String pName, String pDescription, String pTranslationName, int pLines, Material pMaterial, CustomInventory pParent, byte pData) {
		this.main = main;
		this.name = pName;
		this.description = pDescription;
		this.data = pData;
	 ...
	 * @return Le parent
	 */
	final public CustomInventory getParent() {
		return parent;
	}
