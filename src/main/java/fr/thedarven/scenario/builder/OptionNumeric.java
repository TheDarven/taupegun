...
public class OptionNumeric extends CustomInventory implements AdminConfiguration, StorablePreset {
	...
	public OptionNumeric(TaupeGun main, String pName, String pDescription, String pTranslationName, Material pMaterial, CustomInventory pParent, int pPosition, NumericHelper infos, byte pData) {
	...
	public OptionNumeric(TaupeGun main, String pName, String pDescription, String pTranslationName, Material pMaterial, CustomInventory pParent, NumericHelper infos, byte pData) {
	...
	public OptionNumeric(TaupeGun main, String pName, String pDescription, String pTranslationName, Material pMaterial, CustomInventory pParent, int pPosition, NumericHelper infos) {
	...
	public OptionNumeric(TaupeGun main, String pName, String pDescription, String pTranslationName, Material pMaterial, CustomInventory pParent, NumericHelper infos) {
