...
public abstract class InventoryDelete extends CustomInventory {

	private static String CONFIRM_ACTION = "✔ Confirmer";
	private static String CANCEL_ACTION = "✘ Annuler";
	
	public InventoryDelete(TaupeGun main, CustomInventory parent, String pName, String pTranslationName, int pPosition) {
