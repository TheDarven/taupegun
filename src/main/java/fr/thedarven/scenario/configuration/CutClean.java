...
public class CutClean extends OptionBoolean {
    ...
    public CutClean(TaupeGun main, ConfigurationInventory parent) {
        super(main, "CutClean", "Aucun cuisson n'est nécessaire avec ce scénario.", "MENU_CONFIGURATION_SCENARIO_CUTCLEAN",
                Material.IRON_INGOT, parent, false);
    }
