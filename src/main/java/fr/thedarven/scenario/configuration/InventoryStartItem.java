...
public class InventoryStartItem extends CustomInventory implements AdminConfiguration, InventoryGiveItem, StorablePreset {

	public InventoryStartItem(TaupeGun main, CustomInventory parent) {
