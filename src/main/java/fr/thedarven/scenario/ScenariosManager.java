...
import fr.thedarven.scenario.children.*;
import fr.thedarven.scenario.helper.NumericHelper;
import fr.thedarven.scenario.helper.StorablePreset;
import fr.thedarven.scenario.kits.InventoryKits;
import fr.thedarven.scenario.languages.InventoryLanguage;
import fr.thedarven.scenario.languages.InventoryLanguageElement;
import fr.thedarven.scenario.players.presets.*;
import fr.thedarven.scenario.players.credits.InventoryCredit;
import fr.thedarven.scenario.teams.InventoryCreateTeam;
import fr.thedarven.scenario.teams.InventoryTeams;
import fr.thedarven.scenario.teams.InventoryTeamsColor;
import fr.thedarven.scenario.teams.InventoryTeamsRandom;
