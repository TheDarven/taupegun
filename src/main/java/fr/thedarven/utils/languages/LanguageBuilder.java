...
public class LanguageBuilder {
    private static final Map<String, LanguageBuilder> allElements = new HashMap<>();

    private final String name;
    private final Map<String, LanguageElement> content;

    public LanguageBuilder(String name) {
        this.name = name;
        content = new HashMap<>();
        allElements.putIfAbsent(name, this);
    }
    ...
    public static String getContent(String name, String valueTitle, boolean defaultValue) {
        ...
        return element.getInsideContent(TaupeGun.getInstance().getLanguageManager().getLanguage(), valueTitle, defaultValue);
    }
    ...
    private String getInsideContent(String language, String valueTitle, boolean defaultValue) {
        ...
        if (defaultValue) {
            element = this.content.get(GlobalVariable.DEFAULT_LANGUAGE);
            if (element != null) {
