...
public class InventoryRegister {
	...
	public static Timber timber = new Timber("Timber", "Les arbres se cassent entièrement lorsqu'un joueur casse une bûche.", "MENU_CONFIGURATION_SCENARIO_TIMBER", Material.LOG, scenarios, false);
