		...
		if(currentGame == this) {
			if(Bukkit.getServer().getOnlineMode()) {
				...
				for(PlayerTaupe pt: PlayerTaupe.getAllPlayerManager()) {	
					...
					addPlayer(new RestPlayer(pt.getUuid(), pt.getName(), pt.getTaupeTeamNumber(), pt.getSuperTaupeTeamNumber(), teamName, pt.isAlive(), pt.getLastConnection(), pt.getUpdatedTimePlayed()));
